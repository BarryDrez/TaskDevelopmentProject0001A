...
*/
     var Task002Start_70c3ab05_21ce_42b9_bcb8_cd9933b72feeStart_Controller = BaseController.extend({
       ...
       */
       ...
       try{
              ...
              */
              ...
              this.$scope.instance = "Task002Start_70c3ab05_21ce_42b9_bcb8_cd9933b72feeStart_Controller";
              
              }
              catch(exception){
                               console.error("Gadget Exception in init block of Task002Start_70c3ab05_21ce_42b9_bcb8_cd9933b72feeStart_Controller: "+exception);
                                }
       ...
       try{
              ...
              this.$scope.registerAndShowComponents=function(){
       		      ...
       		      var taskTypeID = "70c3ab05-21ce-42b9-bcb8-cd9933b72fee";
            	  ...
            	  _this.restClient.url("/rest/pub/opentask")
   				 ...
   				 .success(function(response){
   					...
   					_this.$scope.eventBus.fireEvent(NotificationConstants.ERROR,"Error Creating Task "+response);
                               ...
                               console.error("Gadget Exception in defineScope block of Task002Start_70c3ab05_21ce_42b9_bcb8_cd9933b72feeStart_Controller: "+exception);
                                }  
       },
});
/*
...
*/
Task002Start_70c3ab05_21ce_42b9_bcb8_cd9933b72feeStart_Controller.$inject = [ '$scope', 'RestServiceProvider','EventBus','$log','config','$builder'];
