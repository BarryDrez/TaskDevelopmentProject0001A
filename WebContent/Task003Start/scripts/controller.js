...
*/
     var Task003Start_b22e82f1_dd42_4165_888b_5c98cb695239Start_Controller = BaseController.extend({
       ...
       */
       ...
       try{
              ...
              */
              ...
              this.$scope.instance = "Task003Start_b22e82f1_dd42_4165_888b_5c98cb695239Start_Controller";
              
              }
              catch(exception){
                               console.error("Gadget Exception in init block of Task003Start_b22e82f1_dd42_4165_888b_5c98cb695239Start_Controller: "+exception);
                                }
       ...
       try{
              ...
              this.$scope.registerAndShowComponents=function(){
       		      ...
       		      var taskTypeID = "b22e82f1-dd42-4165-888b-5c98cb695239";
            	  ...
            	  _this.restClient.url("/rest/pub/opentask")
   				 ...
   				 .success(function(response){
   					...
   					_this.$scope.eventBus.fireEvent(NotificationConstants.ERROR,"Error Creating Task "+response);
                               ...
                               console.error("Gadget Exception in defineScope block of Task003Start_b22e82f1_dd42_4165_888b_5c98cb695239Start_Controller: "+exception);
                                }  
       },
});
/*
...
*/
Task003Start_b22e82f1_dd42_4165_888b_5c98cb695239Start_Controller.$inject = [ '$scope', 'RestServiceProvider','EventBus','$log','config','$builder'];
