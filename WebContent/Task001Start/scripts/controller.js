...
*/
     var Task001Start_0bac6b76_41d0_41a4_a9bb_c35a1b1e9e36Start_Controller = BaseController.extend({
       ...
       */
       ...
       try{
              ...
              */
              ...
              this.$scope.instance = "Task001Start_0bac6b76_41d0_41a4_a9bb_c35a1b1e9e36Start_Controller";
              
              }
              catch(exception){
                               console.error("Gadget Exception in init block of Task001Start_0bac6b76_41d0_41a4_a9bb_c35a1b1e9e36Start_Controller: "+exception);
                                }
       ...
       try{
              ...
              this.$scope.registerAndShowComponents=function(){
       		      ...
       		      var taskTypeID = "0bac6b76-41d0-41a4-a9bb-c35a1b1e9e36";
            	  ...
            	  _this.restClient.url("/rest/pub/opentask")
   				 ...
   				 .success(function(response){
   					...
   					_this.$scope.eventBus.fireEvent(NotificationConstants.ERROR,"Error Creating Task "+response);
                               ...
                               console.error("Gadget Exception in defineScope block of Task001Start_0bac6b76_41d0_41a4_a9bb_c35a1b1e9e36Start_Controller: "+exception);
                                }  
       },
});
/*
...
*/
Task001Start_0bac6b76_41d0_41a4_a9bb_c35a1b1e9e36Start_Controller.$inject = [ '$scope', 'RestServiceProvider','EventBus','$log','config','$builder'];
